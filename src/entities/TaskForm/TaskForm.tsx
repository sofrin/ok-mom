import { DialogContent, DialogContentText, MenuItem, Select, TextField } from "@mui/material";
...
export const TaskForm = ({ checked, singleTask, defaultChild, errors, register }: TaskFormProps) => {

  return <DialogContent sx={{ width: 600 }} >
