...
const ChildTaskCardWidget = ({ child, tasks, setOpen, setTasks, setdefaultChild, isLoading, setDraggableTask, draggableTask }: Props) => {
  ...
  return (
    <TaskCardTemplate setTasks={setTasks} child={child} setDraggableTask={setDraggableTask} draggableTask={draggableTask}>
      <Grid container direction="row" item spacing={1} justifyContent='space-between' >
        ...
        <ProgresItem points={totalPoints} filteredTasks={filteredChildTasks} />
      </Grid>
      <CardTaskList isLoading={isLoading} tasks={tasks} setTasks={setTasks} setDraggableTask={setDraggableTask} draggableTask={draggableTask} child={child} filteredTasks={filteredChildTasks} />
